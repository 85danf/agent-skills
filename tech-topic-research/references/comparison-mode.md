...
| **Phase 3 (Fan-out)**         | If "alternatives" or "comparison" is a focus area — or always in comparison mode — also run the `comparison-searcher` specialist (`references/specialists/comparison-searcher.md`).                                                                                                                                                                                                                                                              |
