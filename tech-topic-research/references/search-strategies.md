...
> **For spawned subagents:** if a tech-topic-research specialist file (`references/specialists/<role>.md`) sent you here, read the section that matches your role:
>
...
2. Spawn 1–2 targeted searcher subagents (not a full re-run) for the new
   angle. Use the existing `references/specialists/<role>.md` template, not a new one.
