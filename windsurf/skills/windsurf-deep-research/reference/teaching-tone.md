...
Adapt teaching approach based on user context from Phase 2.
...
| **Learn to use**          | Practical steps, patterns, pitfalls. Minimize theory.                              |
| **Understand concepts**   | Mental models, architecture, "why it works this way." Theory OK.                   |
