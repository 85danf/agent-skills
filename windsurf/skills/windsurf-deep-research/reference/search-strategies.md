...
**Where:** Architecture posts, "how we use X at Y" engineering blogs, integration guides, starter templates, production configs.

**Query patterns:**
- `"{topic} integration patterns"`
- `"{topic} architecture example production"`
- `"{topic} with {common_companion_tech}"`
- `"{topic} best practices production {current_year} / {current_year + 1}"`
- `"how we use {topic} at" engineering blog`

**Quality signals:** Concrete system context, diagrams or code snippets, stated scale, trade-offs discussed, recent and maintained.

**Red flags:** Marketing-only posts, vague "case study" claims without specifics, outdated stacks without context.
