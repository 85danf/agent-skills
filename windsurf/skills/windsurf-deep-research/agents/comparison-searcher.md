...
1. Read `reference/search-strategies.md` and use the **Comparison Content** section for query patterns and fairness checks.
...
4. Search: head-to-head posts, benchmarks with methodology, migration reports, community debates, official comparison pages.
5. Evaluate fairness: balanced vs biased, same criteria, recent data, author affiliation, methodology disclosed.
