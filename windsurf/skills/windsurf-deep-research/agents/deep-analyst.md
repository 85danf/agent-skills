...
1. Read `reference/search-strategies.md` and use the **Official Documentation**, **Community Discussions**, and **Comparison Content** sections for query patterns and credibility checks.
2. Read `reference/analysis-tools.md` and use the **Source Quality Ratings** (A–E) for every source.
3. Review the context provided (gist, focus areas) to identify analytical gaps.
4. Run web searches for:
...
5. **Red Team thinking:** Actively search for reasons NOT to use this. Don't soften genuine weaknesses.
6. **Trajectory signals:** GitHub stars trend, downloads, adoption announcements, major version changes, maintainer health.
